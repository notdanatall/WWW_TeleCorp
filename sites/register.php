...
<body class="login">
    <div class="container transparent rounded-5 my-5 pd-5">
        ...
        <form action="registerscript.php" method="POST">
            <input type="text" name="name" class="form-control" placeholder="Jméno"   > <br>
            <input type="text" name="surname" class="form-control" placeholder="Příjmení"   > <br>
            <input type="text" name="organization" class="form-control" placeholder="Organizace"   > <br>
            ...
            <div class="g-recaptcha" data-sitekey="6Lel62gqAAAAANpZxZz-owO7a0RXTL8TBbcS0fHC"></div> <br>
